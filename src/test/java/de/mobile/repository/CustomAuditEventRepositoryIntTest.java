...
import de.mobile.config.audit.AuditEventConverter;
import de.mobile.domain.PersistentAuditEvent;
...
import static de.mobile.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
