...
import de.mobile.config.Constants;
import de.mobile.domain.Authority;
import de.mobile.domain.PersistentToken;
import de.mobile.domain.User;
import de.mobile.repository.AuthorityRepository;
import de.mobile.repository.PersistentTokenRepository;
import de.mobile.repository.UserRepository;
import de.mobile.security.AuthoritiesConstants;
import de.mobile.service.MailService;
import de.mobile.service.UserService;
import de.mobile.service.dto.PasswordChangeDTO;
import de.mobile.service.dto.UserDTO;
import de.mobile.web.rest.errors.ExceptionTranslator;
import de.mobile.web.rest.vm.KeyAndPasswordVM;
import de.mobile.web.rest.vm.ManagedUserVM;
